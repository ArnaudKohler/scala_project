...
import operations.BreadthFirstSearch

class BreadthFirstSearchTest extends AnyFlatSpec {
    "A BreadthFirstSearch" should "be able to find a result in a graph" in {
        ...
        val result = BreadthFirstSearch.bfs(u, n1)
